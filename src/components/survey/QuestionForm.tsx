...
export function QuestionForm({
  ...
  return (
    <div className="grid gap-6">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <QuestionSetting
          label="Question Setting 1"
          options={['Option 1', 'Option 2']}
        />
        <QuestionSetting
          label="Question Setting 2"
          options={['Option 1', 'Option 2']}
        />
      </div>
      ...
      <div className="grid gap-3">
        ...
        <div
          className={cn(
            'grid gap-3',
            showOptions ? 'grid-cols-2 md:grid-cols-4' : 'grid-cols-1'
          )}
        >
          {showOptions ? (
            <>
            ...
            <Input
              disabled
              placeholder="Free text (no options)"
