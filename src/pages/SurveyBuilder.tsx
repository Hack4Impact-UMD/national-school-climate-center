  ...
  const navigate = useNavigate();
    ...
    return (
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-4 mb-5">
        <button
          onClick={() => navigate('/surveys/create/challenge')}
          className="rounded-md border bg-transparent p-6 flex-none w-full md:w-80 md:h-60 min-h-[12rem] hover:bg-muted/40 transition-colors cursor-pointer"
        >
      ...
      <div className="flex flex-col md:flex-row items-stretch gap-4 mb-5">
        <ExistingSurvey
          title="Survey 1"
          description="This survey is about the climate of the school."
        />
        <ExistingSurvey
          title="Survey 2"
          description="This survey is about the climate of the school."
